  ...
  return (
    <>
      ...
      <section className="relative py-20 md:py-28 lg:py-36 overflow-hidden mt-16 md:mt-24 lg:mt-32">
        ...
        >
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 md:mb-6 tracking-tight text-black font-title">
            How It Works
          </h2>
        ...
        <div className="relative flex flex-col md:flex-row min-h-[1200px] md:min-h-[1000px]">
          {/* Left Half - All 4 Boxes */}
          <div className="flex-1 bg-white relative">
            <div className="flex items-center justify-center px-4 sm:px-6 md:px-12 py-12 md:py-20 h-full relative z-10">
              <div className="w-full max-w-2xl space-y-4 md:space-y-5">
                ...
                <motion.div
                  ...
                  className="bg-white p-6 md:p-8 border-2 border-dashed border-black relative"
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold mb-2 text-black">Service Providers</h3>
      ...
      <section className="relative py-16 md:py-24 lg:py-32 px-6 border-t border-black/10">
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-10 max-w-6xl mx-auto">
            ...
            <HoverRevealCard delay={0.1} className="h-full">
              <div className="bg-white p-8 md:p-10 border-2 border-dashed border-black h-full relative">
                <div className="mb-6">
                  <span className="text-xl font-bold text-red-600 tracking-wider">[1]</span>
                </div>
                <h3 className="text-2xl font-bold mb-4 text-black">Pay-Per-Request</h3>
