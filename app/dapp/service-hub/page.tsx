...
import { X402PaymentPanel } from '../../components/x402/X402PaymentPanel';
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden sm:flex items-center gap-4">
              {isConnected ? (
                ...
                <button
                  ...
                  className="px-5 py-2 bg-red-600 text-white rounded-lg text-sm font-light hover:bg-red-700 transition-all duration-300 min-h-[44px]"
                >
                  Connect Wallet
                </button>
              )}
            ...
            <div className="sm:hidden">
              {isConnected ? (
                ...
                <button
                  onClick={connectWallet}
                  className="px-3 py-2 bg-red-600 text-white rounded-lg min-w-[44px] min-h-[44px] flex items-center justify-center"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {activeTab === 'marketplace' && (
          <div>
            ...
            <div className="relative -mx-6 sm:-mx-8 lg:-mx-12 px-4 sm:px-6 md:px-8 lg:px-12 py-12 sm:py-16 md:py-20 mb-12 md:mb-16 overflow-hidden">
              {/* Gradient background */}
              <div className="absolute inset-0 bg-gradient-to-br from-red-600/10 via-transparent to-black" />
              ...
              <div className="relative z-10 max-w-6xl mx-auto">
                <div className="text-left mb-12">
                  <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-light text-white mb-4 md:mb-6 leading-tight">
                    Discover <span className="font-title text-white">Atlas402</span> Services
                  </h1>
                ...
                <div className="relative">
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="flex items-center justify-center gap-4 sm:gap-6 md:gap-8 flex-wrap">
                        ...
                        <div className="group relative">
                          <div className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-xl bg-white/[0.08] backdrop-blur-sm border border-white/20 p-3 sm:p-4 transition-all duration-500 hover:scale-110 hover:bg-white/[0.12] hover:border-red-600/50 hover:shadow-[0_0_30px_rgba(116,161,128,0.3)]">
                            <Image
                              src="/logos/base.jpg"
                              alt="Base"
                              width={64}
                            ...
                            />
                            <div className="absolute -top-2 -right-2 w-5 h-5 bg-red-600 rounded-full flex items-center justify-center border-2 border-black">
                              <span className="w-2 h-2 bg-white rounded-full animate-pulse"></span>
                            </div>
                          </div>
                          <p className="text-center text-xs text-white/80 mt-2 font-light">Base</p>
                          <p className="text-center text-[10px] text-red-600 font-light">Live</p>
                        </div>
                  ...
                  <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-red-600/0 via-red-600/10 to-red-600/0 animate-pulse opacity-50 blur-xl -z-10" />
                </div>
              </div>
            </div>
        ...
        {activeTab === 'dashboard' && (
          <div>
                ...
                {!isConnected ? (
                  <div className="relative overflow-hidden">
                    ...
                    <div className="relative text-center py-16 px-8 border border-white/10">
                      ...
                      <button
                        onClick={connectWallet}
                        className="px-8 py-3 bg-red-600 text-white rounded-lg text-base font-light hover:bg-red-700 transition-all duration-300"
                      >
                        Connect Wallet
                      </button>
                    </div>
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="bg-black/40 backdrop-blur-sm border border-white/10 p-8">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="flex items-center gap-2 p-3 bg-white/5 rounded border border-white/10 hover:border-red-600/30 transition-all">
                        ...
                        <div className="flex items-center gap-2 p-3 bg-white/5 rounded border border-white/10 hover:border-red-600/30 transition-all">
                          ...
                          <div>
                            ...
                            <p className="text-[10px] text-red-600 font-light">Mainnet</p>
                          </div>
                        </div>
                    ...
                    {paymentHistory.length === 0 ? (
                      ...
                      <div className="space-y-2">
                        {paymentHistory.slice(0, 10).map((payment, index) => (
                          <div key={index} className="flex items-center justify-between p-4 bg-white/5 rounded border border-white/10 hover:bg-white/10 hover:border-red-600/30 transition-all">
                            ...
                            <div className="flex items-center gap-4">
                              ...
                              <a
                                ...
                                className="px-3 py-1.5 bg-red-600 text-white rounded text-xs font-light hover:bg-red-700 transition-all"
                              >
                                View
                              </a>
                            </div>
            ...
            <div className="relative overflow-hidden mb-16">
              {/* Gradient background */}
              <div className="absolute inset-0 bg-gradient-to-r from-black via-[#0a0a0a] to-red-600/20" />
              ...
              <div className="relative z-10 p-12 border border-white/10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
                  {/* Express Starter */}
                  <div className="group bg-white/5 border border-white/10 p-6 hover:border-red-600/50 transition-all duration-300">
                    <div className="flex items-start justify-between mb-4">
                      <h3 className="font-light text-lg text-white">Express.js</h3>
                      <svg className="w-5 h-5 text-gray-500 group-hover:text-red-600 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                    ...
                    <button
                      ...
                      className="w-full px-4 py-2 bg-white/10 text-white rounded hover:bg-red-600 transition-all duration-300 text-sm font-light border border-white/10"
                    >
                      View Guide
                    </button>
                  </div>
                  ...
                  <div className="bg-red-600/20 border border-red-600/50 p-6 hover:bg-red-600/30 transition-all duration-300">
                    <div className="flex items-start justify-between mb-4">
                    ...
                    <button
                      onClick={() => setShowServiceRegistration(true)}
                      className="w-full px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 transition-all duration-300 text-sm font-light"
                    >
                      Register Now
                    </button>
                  </div>
